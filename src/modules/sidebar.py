...
def setup_sidebar():
    ...
    with st.sidebar:
        ...
        st.markdown("<p>Projeto Integrador <a href='https://ava.univesp.br/' style='color:#00bcd4; text-decoration: none;'>Desenvolvido por Pablo e Marcelo</a></p>", unsafe_allow_html=True)
        st.markdown("<hr>", unsafe_allow_html=True)
